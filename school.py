...
FW = Tk()
FW.title("School Extra Activities Systems")
FW.geometry("1600x1000+0+0")
label = Label(text="SCHOOL Extra Activities System", font=("times new roman", 50), bg="blue", fg="white")
label.pack(side=TOP, fill=X)
user1 = Label(text="STUDENT NAME", font=("times new roman", 23), anchor=CENTER, fg="blue")
user1.place(x=580, y=120)
user = Entry(width=17, bd=5, font=("times new roman", 20), fg="black")
user.place(x=570, y=200)
label.pack(side=TOP, fill=X)
user2 = Label(text="PASSWORD", font=("times new roman", 23), fg="blue")
user2.place(x=610, y=280)
user3 = Entry(width=17, show="*", bd=5, font=("times new roman", 20), fg="black")
user3.place(x=570, y=360)
def second():
    global secondw
    secondw = Tk()
    secondw.title("School Extra Activities Systems")
    ...
    def studentid():
        rot = Tk()
        rot.title("School Extra Activities Systems")
        rot.geometry("1600x1000+0+0")
        mainlabel = Label(rot, text="STUDENT DETAILS", font=("times new roman", 35), bg="blue", fg="white")
        mainlabel.pack(side=TOP, fill=X)
        chat1 = ttk.Treeview(rot, height=20, columns=('name', 'surname', 'activity fee'), selectmode="extended")
        chat1.heading('#0', text='ID', anchor=CENTER)
        chat1.heading('#1', text='NAME', anchor=W)
        chat1.heading('#2', text='Activity FEE', anchor=W)
    ...
    def viewenquiry2():
        rt = Tk()
        rt.title("School Extra Activities Systems")
        rt.geometry("1600x1000+0+0")
        mainlabel = Label(rt, text="Parent", font=("times new roman", 35), bg="black", fg="white")
        mainlabel.pack(side=TOP, fill=X)
    ...
    mainlabel = Label(secondw, text="School Extra Activities Systems", font=("times new roman", 35), bg="blue", fg="white")
    mainlabel.pack(side=TOP, fill=X)
    button = Button(secondw, width=15, font=("arial", 20), text="REGISTRATION", bg="blue", fg="white", command=distroy4)
    button.place(x=10, y=480)
    enquiry = Button(secondw, width=15, font=("arial", 20), text="FEE DETAILS", bg="blue", fg="white", command=distroy5)
    enquiry.place(x=280, y=480)
    fee_details = Button(secondw, width=15, font=("arial", 20), text="ENQUIRY", bg="blue", fg="white", command=enquiry1)
    fee_details.place(x=560, y=480)
    viewenquiry = Button(secondw, width=15, font=("arial", 20), text="VIEW ENQUIRY", bg="blue", fg="white", command=viewenquiry2)
    viewenquiry.place(x=840, y=480)
    viewenquiry1 = Button(secondw, width=15, font=("arial", 20), text="STUDENT DETAILS", bg="blue", fg="white", command=studentid)
...
def root():
    ...
    root.title("School Extra Activities Systems")
    global entry1
    global entry2
    global entry3
    global entry4
    ...
    calculation2 = 2000
    label = Label(root, text="REGISTRATION FORM", font=("arial", 25), bg="blue", fg="white")
    label.pack(side=TOP, fill=X)
    ...
    box['values'] = ['SELECT', 'Drawing', 'Swimming', 'Chess', 'Play', "Singing", "Dancing", "Recitation"]
    box.current(0)
    box.place(x=503, y=395)

    checkbutton1 = Checkbutton(root, text="Pre-primary", variable=a)
    checkbutton1.place(x=450, y=455)

    checkbutton1 = Checkbutton(root, text="Standard 1", variable=c)
    checkbutton1.place(x=550, y=455)

    checkbutton1 = Checkbutton(root, text="Standard 2", variable=d)
    checkbutton1.place(x=650, y=455, )

    checkbutton1 = Checkbutton(root, text="Standard 3", variable=b)
    checkbutton1.place(x=750, y=455)
    b.set(0)
    a.set(0)
    c.set(0)
    d.set(0)
    ...
    def dis():
        ...
        #print(root.filename)
        #os.chdir('c:\\')
        #shutil.move((root.filename),("C:\\Users\\User\\Desktop\\dataset"))
    #win= Tk()
    #def show_msg():
       #tkinter.messagebox.messagebox.showinfo("Activity fee is $100")
    #Label(win, text= "Activity Fee", font= ('Aerial 17 bold italic')).pack(pady= 30)

    button1 = Button(root, text="CALCULATE FEE", width=14, font=("arial", 10), bg="green", fg="black", command=calculate)
    button1.place(x=530, y=630)


    button12 = Button(root, text="BACK", width=17, font=("arial", 17), bg="green", fg="black", command=dis)
    button12.place(x=0, y=0)

    button2 = Button(root, text="SUBMIT FORM", width=14, font=("arial", 10), bg="green", fg="black", command=msg)
    button2.place(x=660, y=630)

    button3 = Button(root, text="RESET", width=14, font=("arial", 10), bg="green", fg="black", command=golu)
    button3.place(x=395, y=630)

    button4 = Button(root, text="SEARCH", width=14, font=("arial", 10), bg="green", fg="black", command=all)
    button4.place(x=1100, y=150)

    button4 = Button(root, text="UPDATE", width=14, font=("arial", 10), bg="green", fg="black", command=update)
    button4.place(x=950, y=630)

    button5 = Button(root, text="DELETE", width=14, font=("arial", 10), bg="green", fg="black", command=delete)
    button5.place(x=800, y=630)

    button6=Button(root,text="ENQUIRY",width=14,font=("arial",10),bg="green",command=window )
    button6.place(x=400 , y=630)
...
def enquiry1():
    ...
    label22 = Label(enquiry1, text="ENQUIRY", font=("arial", 25), bg="blue", fg="black")
    ...
    button = Button(enquiry1, text="Submit", width=30, bg="green", fg="black", command=r)
    button.place(x=500, y=320)
    button1 = Button(enquiry1, text="BACK", width=30, bg="green", fg="black", command=enquiry1destroy)
    ...
    box2['values'] = ['SELECT', 'Help related to Fee', 'Contact high authority', 'FEE DETAILS', 'Slot chnage support']
    box2.current(0)
...
def window():
    ...
    def distroy3():
        main.destroy()
        second()
    button = Button(main, text="BACK", width=30, bg="green", fg="black", command=distroy3)
    ...
    button22 = Button(main, text="LOGIN", width=26, font=("arial", 10), bg="green", fg="black", command=cat)
    button22.place(x=400, y=310)
    button23 = Button(main, text="ADD FEE", width=26, font=("arial", 10), bg="green", fg="black", command=installment2)
    button23.place(x=650, y=310)
    entry29 = Entry(main, bd=5, width=20, font=("arial", 15))
    entry29.place(x=650, y=200)
    button28 = Button(main, text="RESET", width=26, font=("arial", 10), bg="green", fg="black", command=reset2)
...
def calculation():
    ...
    print(GANDER)
    CALCULATE = calculate.get()
    if NAME == ("") and SUR == ("") and EMAIL == ("") and BOX == ("SELECT") and GANDER == (3) and A == (0) and B == (0) and C == (0) and D == (0):
        kal = tkinter.messagebox.showinfo(" DETAILS INVALID", "FILL ALL THE DETAILS")
    else:
        global x
        if box.get() == "Pre-primary" and gander.get() == 0:
            x = (calculation2 - calculation2 * 20 / 100)
            entry5.configure(state="normal")
            entry5.delete(0, END)
            entry5.insert(0, x)
            entry5.configure(state="disable")
        if box.get() == "Standard 1" and gander.get() == 1:
            x = (calculation2 - calculation2 * 10 / 100)
            entry5.configure(state="normal")
            entry5.delete(0, END)
            entry5.insert(0, x)
            entry5.configure(state="disable")
        if box.get() == "Standard 2" and gander.get() == 1:
            x = (calculation2)
            entry5.configure(state="normal")
            entry5.delete(0, END)
            entry5.insert(0, x)
            entry5.configure(state="disable")
        if box.get() == "Standard 3" and gander.get() == 0:
            x = (calculation2 - calculation2 * 10 / 100)
            entry5.configure(state="normal")
            entry5.delete(0, END)
            entry5.insert(0, x)
        ...
        if box.get() == "Standard 4" and gander.get() == 1:
            x = (calculation2)
            entry5.configure(state="normal")
            entry5.delete(0, END)
            entry5.insert(0, x)
            entry5.configure(state="disable")
        if box.get() == "Standard 5" and gander.get() == 0:
            x = (calculation2 - calculation2 * 10 / 100)
            entry5.configure(state="normal")
            entry5.delete(0, END)
            entry5.insert(0, x)
...
def msg():
    if branch.get() == "SELECT" or gander.get() == 3 or (
            b.get() == 0 and a.get == 0 and c.get() == 0 and d.get() == 0):
...
INQUIRY = Button(text="LOGIN", width=17, font=("arial", 20), bg="green", fg="black", command=login)
